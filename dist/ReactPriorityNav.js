(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactPriorityNav"] = factory(require("react"), require("react-dom"));
	else
		root["ReactPriorityNav"] = factory(root["React"], root["ReactDOM"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _priorityNav = __webpack_require__(1);

	Object.defineProperty(exports, 'default', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_priorityNav).default;
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PriorityNav = function (_Component) {
	    (0, _inherits3.default)(PriorityNav, _Component);

	    function PriorityNav(props) {
	        (0, _classCallCheck3.default)(this, PriorityNav);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (PriorityNav.__proto__ || (0, _getPrototypeOf2.default)(PriorityNav)).call(this, props));

	        _this.handleResize = _this.onResize.bind(_this);
	        _this.handleDocMouseOver = _this.onDocMouseOver.bind(_this);
	        _this.handleNavMouseOver = _this.onNavMouseOver.bind(_this);
	        _this.handleNavMouseOut = _this.onNavMouseOut.bind(_this);
	    ...
	    (0, _createClass3.default)(PriorityNav, [{
	        key: 'onResize',
	        ...
	        key: 'onDocMouseOver',
	        value: function onDocMouseOver(e) {
	            var domNode = (0, _reactDom.findDOMNode)(this);
	            var isChild = domNode.contains(e.target);
	            if (domNode && !isChild) {
	        ...
	        value: function render() {
	            var _state = this.state,
	                outterClass = _state.outterClass,
	            ...
	            var classNames = (0, _util.classNames)(className, outterClass, { 'priority-nav-has-dropdown': navItems.length });
	            return _react2.default.createElement(
	                Tag,
	                { ref: OUTER, className: classNames, id: id },
	                this.renderMenu(),
	                this.renderNav()
	            );
	        }
	        ...
	        value: function renderMenu() {
	            ...
	            var _props2 = this.props,
	                ...
	                navRef = _props2.navRef;

	            return _react2.default.Children.map(children, function (child) {
	                if (child.ref == navRef) {
	                    return (0, _react.cloneElement)(child, {
	                        children: _this2.updateItems(child.props.children),
	                        ref: MENU_LIST
	                    });
	                }
	                return child;
	        ...
	        value: function renderNav() {
	            var navDropdown = this.props.navDropdown;

	            var spanClasses = (0, _util.classNames)(navDropdown + '-wrapper', 'priority-nav__wrapper');
	            return _react2.default.createElement(
	                'span',
	        ...
	        value: function renderNavList() {
	            var _props3 = this.props,
	                navDropdown = _props3.navDropdown,
	                navStyles = _props3.navStyles;

	            var classNames = (0, _util.classNames)(navDropdown, 'priority-nav__dropdown', { 'show': this.state.navVisible });
	            var props = {
	            ...
	            return _react2.default.createElement(
	                'ul',
	                (0, _extends3.default)({}, props, { style: navStyles }),
	                this.state.navVisible && this.state.navItems.length && this.state.navItems
	            );
	        }
	        ...
	        key: 'renderNavToggle',
	        value: function renderNavToggle() {
	            var _props4 = this.props,
	                navDropdownLabel = _props4.navDropdownLabel,
	                navDropdownToggle = _props4.navDropdownToggle,
	                navItemActiveClass = _props4.navItemActiveClass;

	            var props = {
	                ref: TOGGLE,
	                onMouseOver: this.handleNavMouseOver,
	                onClick: this.handleNavMouseOut,
	                className: (0, _util.classNames)(navDropdownToggle, (0, _defineProperty3.default)({}, navItemActiveClass, this.state.navItemActive), { 'priority-nav-is-visible': this.state.navItems.length }, { 'is-open': this.state.navVisible }, 'priority-nav__dropdown-toggle')
	            };
	            return _react2.default.createElement(
	                'button',
	                props,
	        ...
	        key: 'updateItems',
	        value: function updateItems(children) {
	            var _this3 = this;

	            this.updateMenuItems(children);
	            var length = this.state.menuItems.length;

	            _react2.default.Children.forEach(children, function (child, i) {
	                // calculate which set we're needing to update
	                var items = i < length ? 'menuItems' : 'navItems';
	                var index = i < length ? i : i - length;

	                // clone updated children into correct set
	                var item = _this3.state[items][index];
	                var element = (0, _react.cloneElement)(item, child.props);

	                _this3.state[items][index] = element;
	            }, this);
	        ...
	        key: 'updateMenuItems',
	        value: function updateMenuItems(children) {
	            if (this.state.menuItems.length) return;
	            this.state.menuItems = _react2.default.Children.map(children, function (li, i) {
	                // use this opportunity to add a ref to each menu item
	                return (0, _react.cloneElement)(li, { ref: 'ITEM' + i });
	            });
	        }
	        ...
	        key: 'updateToggleActiveState',
	        value: function updateToggleActiveState() {
	            var _this4 = this;

	            var itemActiveClass = this.props.itemActiveClass;

	            this.state.navItemActive = false;
	            this.state.navItems.forEach(function (child) {
	                var className = child.props.className;
	                var itemActive = className && className.includes(itemActiveClass);
	                if (!_this4.state.navItemActive && itemActive) {
	                    _this4.state.navItemActive = true;
	                }
	            }, this);
	        }
	        ...
	        value: function calculateWidths() {
	            var domNode = (0, _reactDom.findDOMNode)(this);
	            var totalWidth = (0, _util.getElementContentWidth)(domNode);
	            var toggleWidth = this.refs[TOGGLE] ? this.refs[TOGGLE].offsetWidth : 0;
	            return {
	                total: totalWidth,
	        ...
	        value: function doesItFit() {
	            ...
	            var _calculateWidths = this.calculateWidths(),
	                total = _calculateWidths.total,
	                toggle = _calculateWidths.toggle,
	                offset = _calculateWidths.offset;

	            var totalWidth = 0;

	            // check if all menu items full within available width
	            var toRemove = menuItems.reduce(function (remove, item) {
	                var itemWidth = _this5.refs[item.ref].offsetWidth;
	            ...
	            this.toMenu(navItems.reduce(function (add, item) {
	                var itemWidth = _this5.breaks[item.ref];
	        ...
	        key: 'toDropDown',
	        value: function toDropDown(items) {
	            var _this6 = this;
	            ...
	            items.forEach(function (item) {
	                var domNode = _this6.refs[item.ref];
	                _this6.breaks[item.ref] = domNode.offsetWidth;
	            }, this);
	            this.forceUpdate();
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.viewportSize = exports.getElementContentWidth = exports.classNames = undefined;
	 ...
	 * @returns {number}
	 */
	var getElementContentWidth = exports.getElementContentWidth = function getElementContentWidth(element) {
	 ...
	 */
	var viewportSize = exports.viewportSize = function viewportSize() {
	    var doc = document,
	        w = window;
